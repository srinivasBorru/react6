    ...
    const links = [
        {
            ...
            href: 'https://www.linkedin.com/in/srinivas-borru-b02784250/',
            style: 'rounded-tr-md'
        },
        {
            id: 2,
            ...
            href: 'https://github.com/srinivasBorru',
        },
        {
            id: 3,
            child: (
            ...
            href: 'mailto:srinivasborru19@gmail.com',
        },
        {
            id: 4,
            child: (
            ...
            href: 'https://drive.google.com/file/d/1Vw_q8CaJCx7kkTYaWDv3oDXPBwM1VTya/view?usp=sharing',
